...
// Source: github.com/zbliujia/go-libp2p/core/network (interfaces: ProtocolScope)
//
// Generated by this command:
//
//	mockgen -package mocknetwork -destination mock_protocol_scope.go github.com/zbliujia/go-libp2p/core/network ProtocolScope
//
