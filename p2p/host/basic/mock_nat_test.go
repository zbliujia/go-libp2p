...
// Source: github.com/zbliujia/go-libp2p/p2p/host/basic (interfaces: NAT)
//
// Generated by this command:
//
//	mockgen -build_flags=-tags=gomock -package basichost -destination mock_nat_test.go github.com/zbliujia/go-libp2p/p2p/host/basic NAT
//
