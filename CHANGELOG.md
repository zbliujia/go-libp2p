...
# [v0.27.0](https://github.com/zbliujia/go-libp2p/releases/tag/v0.27.0)
...
**Full Changelog**: https://github.com/zbliujia/go-libp2p/compare/v0.26.0...v0.26.3
...
#### [Removed Circuit Relay v1](https://github.com/zbliujia/go-libp2p/pull/2107) <!-- omit in toc -->
...
#### [Unlimited Relay v2](https://github.com/zbliujia/go-libp2p/pull/2125) <!-- omit in toc -->
...
### [Stop sending detailed error messages on closing QUIC connections](https://github.com/zbliujia/go-libp2p/pull/2112) <!-- omit in toc -->
